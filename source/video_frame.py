...
video_folder = "/home/siwon/dev/Deeplearning-6/data_video/"  # 여기에 입력 비디오 폴더 경로를 입력하세요.
output_folder = "/home/siwon/dev/Deeplearning-6/data_video/"       # 여기에 출력 프레임이 저장될 폴더 경로를 입력하세요.
target_frame_count = 40         # 여기에 원하는 프레임 수를 입력하세요.
